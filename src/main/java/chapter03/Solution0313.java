...
public class Solution0313 {
    public static void main(String[] args) {
        ...
        if (status == 0) {
            ...
            } else if (income <= 208250) {
                tax = 16700 * 0.1 + (67900 - 16700) * 0.15 + (137050 - 67900) * 0.25 + (income - 137050) * 0.28;
            } else if (income <= 372950) {
                tax = 16700 * 0.1 + (67900 - 16700) * 0.15 + (137050 - 67900) * 0.25 + (208250 - 137050) * 0.28 + (income - 208250) * 0.33;
            } else {
                tax = 16700 * 0.1 + (67900 - 16700) * 0.15 + (137050 - 67900) * 0.25 + (208250 - 137050) * 0.28 + (372950 - 208250) * 0.33 + (income - 372950) * 0.35;
            }
        } else if (status == 2) {
            if (income <= 8350) {
                tax = income * 0.1;
